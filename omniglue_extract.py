...
class OmniGlue:
  ...
  def extract_features(self,image):
    ...
    sp_features = self.sp_extract(image)
    ...
    return sp_features,dino_descriptors
  def FindMatches(self, image0: np.ndarray, image1: np.ndarray,sp_features0,sp_features1,dino_descriptors0,dino_descriptors1):
